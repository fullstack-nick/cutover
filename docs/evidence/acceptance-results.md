...
| A50 | **Failed.** The latest full run, `load-1788906898401` on `b3b09db`, included all 3,000 measured movements: 91.733% within two seconds, original-eligibility p99 11,988.404 ms. All 3,300 total effects eventually completed once and all six databases recorded zero deadlocks. Temporary group-commit settings were restored. Captured storage stalls and expired batch snapshots remain under investigation. The at-least-99% target and complete denominator are unchanged. |
