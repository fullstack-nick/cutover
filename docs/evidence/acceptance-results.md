...
| A50 | **Failed.** The latest full run, `load-1788893862792` on `c6486a6`, included all 3,000 measured movements: 6.1% within two seconds, original-eligibility p99 156,213.575 ms. All 3,300 total effects eventually completed once. PostgreSQL recorded 305 adapter route/outbox-budget deadlocks; the [lock-order correction](../adr/0021-bounded-inbox-transactions.md) passes its focused regression and requires renewed full measurement. |
