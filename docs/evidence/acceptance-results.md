...
| A50 | **Failed.** The [latest full run](healthy-load.md), `load-1788913804136` on `c56cff9`, included all 3,000 measured movements: 88.2% within two seconds, original-eligibility p99 11,551.883 ms. All 3,300 total effects eventually completed once and all six databases recorded zero deadlocks. Default durable-commit settings were unchanged. The report includes all 67 resource samples and retained earlier failures. The at-least-99% target and complete denominator remain unchanged. |
