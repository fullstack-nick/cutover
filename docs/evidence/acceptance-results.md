...
| A50 | **Failed.** The latest full run, `load-1788902904030` on `b3b09db`, included all 3,000 measured movements: 91.533% within two seconds, original-eligibility p99 10,616.729 ms. All 3,300 total effects eventually completed once and all six databases recorded zero deadlocks. Intermittent durable-commit stalls remain under investigation. The at-least-99% target and complete denominator are unchanged. |
