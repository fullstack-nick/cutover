...
The [generated inventory](dependencies.json) records the five packaged Java applications built from clean revision `822d3765c2d7098e01a497acedb9a0b362ac7755`: **104 unique bundled Java libraries**, **105 entries across both npm lockfiles**, and **13 pinned infrastructure/base images**. Each Java executable is checked against the SHA-256 recorded when its image was built. Shadow scheduling uses the same executable as extracted execution, under a separate runtime identity.
