...
Specific failure procedures cover [broker outage/rejected publication](../runbooks/broker-failure.md), [blocked lanes](../runbooks/blocked-lane.md), [identity outage](../runbooks/identity-outage.md), [unknown commands](command-investigation.md), [poison-event recovery](message-quarantine.md), [disk pressure](../runbooks/disk-pressure.md), [migration/reversal](../runbooks/zone-migration.md) and [application-image rollback](../runbooks/application-image-rollback.md). The [trust-boundary record](../architecture/trust-boundaries.md) states the protected properties and local limits.
