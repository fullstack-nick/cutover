...
public interface DispatchPort {
    ...
    default JsonNode context(String site,String zone,java.util.List<UUID> movements){throw new dev.cutover.platform.ServiceHttp.Unavailable("Scheduling context is unavailable.");}
