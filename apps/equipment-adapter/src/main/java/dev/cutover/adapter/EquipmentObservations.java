...
public final class EquipmentObservations {
    ...
    public void refresh() {
        ...
        database.transaction(configuration -> {
            ...
            var row=sql.fetchOne("SELECT * FROM equipment_observation WHERE singleton FOR UPDATE");
    ...
    public JsonNode forSite(String site) {
        var row=database.fetchOne("SELECT * FROM equipment_observation WHERE singleton");
    ...
    JsonNode current(DSLContext sql) {
        var row=sql.fetchOne("SELECT * FROM equipment_observation WHERE singleton FOR SHARE");
