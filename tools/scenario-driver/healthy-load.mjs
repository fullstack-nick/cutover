...
try {
  ...
  evidence.latencyDenominator=`All ${measured.length} measured movements, from original immutable movement eligibleAt to durable adapter command recording. Assignment/publication delay is included. The later task-created stage is reported separately. No healthy work is excluded for transient waiting.`;
