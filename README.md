...
**Current status: implementation in progress.** The latest full backend run passed 121 component checks, including 1,000 persisted SQL/Java scheduling comparisons and durable migration proof. Real process checks demonstrate zone migration, reversal and an independent returns product. The [returns evidence](docs/evidence/returns-2026-09-08.md) covers duplicate receipts/events, physical sorting, service restart and browser recovery. Migration latency failures remain visible in the [migration evidence](docs/evidence/zone-migration-2026-09-08.md). Full backup/restore, prepared offline operation, sustained load and the final acceptance bundle remain in development. Follow the [implementation ledger](docs/planning/implementation-progress.md) for evidence and limits.
