...
The latest full load qualification on the `b3b09db` runtime offered two two-line orders and one receipt per second for ten minutes after 60 seconds of warm-up. All 3,000 measured movements were included: **91.533% reached durable adapter acceptance within two seconds; p99 was 10,616.729 ms**. All 3,300 total movements eventually completed once, with zero database deadlocks. The target stays at least 99% within two seconds, measured from original movement eligibility. Intermittent durable-commit stalls remain under investigation; sustained-load qualification is still open.
